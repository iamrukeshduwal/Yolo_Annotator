...
from tkinter import *
# import tkMessageBox, tkFileDialog Here tkMessageBox into messagebox and tkFileDialog to filedialog 
...
##            return
    ...
    '''def loadXML(self, event = None):
        if (self.category == ''):
            messagebox.showinfo("Error", "Please Load Image first")
        else:
            ...
            messagebox.showinfo("Info", "XML parsing complete")
            self.clearBBox()
            self.loadBBox()'''
